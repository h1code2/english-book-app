...
- **发音**：点击喇叭或「发音」按钮朗读，可在美音 / 英音间切换；**内置离线语音兜底**——系统没有可用 TTS 引擎的手机也能发音（长按详情页口音按钮可强制切换离线引擎，美音）
...
- 系统 `TextToSpeech` + 内置 [sherpa-onnx](https://github.com/k2-fsa/sherpa-onnx) 离线语音（vits-piper lessac-medium 模型，随 APK 分发，无网络依赖）
